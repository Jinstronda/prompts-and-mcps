...
<learned_patterns>
<!-- Add project-specific learnings as simple bullets. Examples: -->

Pattern: [Name] - [Brief description] - [When to use]
Mistake: [What happened] - [How to prevent]
Convention: [Area] - [Rule] - [Why]
Optimization: [Problem] - [Solution] - [Impact]
Utility: [Location] - [Purpose] - [Used by]

<!-- Your learnings below: -->
...
3. NEVER remove or edit data bases without EXPLICIT permission. 4
4. Dont Create Summary Documents when not needed. Just add them to README.
5. Only create architecture and how to use documents apart fron README
